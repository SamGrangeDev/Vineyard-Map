...
map.getView().fit([16046294.914255, -4572680.444044, 16048659.061659, -4570787.888670], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Vineyard Map</h2>';
        return titleElement;
    })(),
